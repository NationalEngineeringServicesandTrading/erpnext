...
class TestPurchaseReceipt(FrappeTestCase):
	...
	def test_payment_terms_are_fetched_when_creating_purchase_invoice(self):
		...
		from erpnext.selling.doctype.sales_order.test_sales_order import compare_payment_schedules
	...
	def create_lcv(
		self, receipt_document_type, receipt_document, company, expense_account, charges=50
	):
