	...
	"filters": [
		{
			...
			label: __("Tree Type"),
			fieldtype: "Select",
			options: ["Customer Group", "Customer", "Item Group", "Item", "Territory", "Order Type", "Project", "Cost Center", "Cost Center-Item Group", "Cost Center-Sales Person", "Brand-Sales Region"],
			default: "Customer",
			reqd: 1
		},
		{
